...
export default function Features() {
  ...
  return (
    <div style={{ background: "#fff", color: "#111827", fontFamily: "Inter, system-ui, sans-serif", minHeight: "100vh" }}>
      ...
      {/* ─── FOOTER ─── */}
      <footer style={{ borderTop: "1px solid rgba(17,24,39,0.04)", background: "#fff" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto", padding: "28px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.14em", color: "#D1D5DB" }}>NEXORA</span>
          <p style={{ fontSize: 11, color: "#E5E7EB", textAlign: "center", margin: 0 }}>Clari é suporte clínico. A decisão médica é sempre do profissional.</p>
