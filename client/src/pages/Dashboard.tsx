        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            >
              ...
              <div>
                <p className="text-sm font-medium text-foreground">Charcot IA</p>
